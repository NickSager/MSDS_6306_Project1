...
state_pop$count <- Brewery_Stat$count
...
#Discovered 2 Beer_Names that are not beers, but other products of the brewery
beers_breweries$Beer_ID[1790] #CAN'D AID Foundation
beers_breweries$Beer_ID[1796] #Crowler
